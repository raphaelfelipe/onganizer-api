...
const postUpdateService = ({ id, title, content }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield postsRepository.update(post.id, { title: title, content: content });
    return {
...
exports.default = postUpdateService;

...
const donationUpdateService = ({ id, message }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield donationRepository.update(donation.id, { message: message });
    return { message: 'Donation successfully updated', UpdatedInfo: {
            value: donation === null || donation === void 0 ? void 0 : donation.value,
            message: message
        }
    };
});
exports.default = donationUpdateService;

...
const listUsersService = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const usersReturn = users.map((user) => (Object.assign(Object.assign({}, user), { password: undefined, email: undefined, created_at: undefined, updated_at: undefined, is_admin: undefined })));
    return usersReturn;
});

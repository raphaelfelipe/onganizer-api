...
export class initialMigration1653056978584 implements MigrationInterface {
    name = 'initialMigration1653056978584'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "admin" ("id" uuid NOT NULL, "user_id" uuid NOT NULL, "userId" uuid, CONSTRAINT "REL_f8a889c4362d78f056960ca6da" UNIQUE ("userId"), CONSTRAINT "PK_e032310bcef831fb83101899b10" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "post_comments" ("id" uuid NOT NULL, "user_id" uuid NOT NULL, "post_id" uuid NOT NULL, "comment" character varying(250) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "postId" uuid, CONSTRAINT "PK_2e99e04b4a1b31de6f833c18ced" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "project_user" ("id" uuid NOT NULL, "users_id" uuid NOT NULL, "projects_id" uuid NOT NULL, CONSTRAINT "PK_1cf56b10b23971cfd07e4fc6126" PRIMARY KEY ("id"))`);

...
export class initialMigration1653587505546 implements MigrationInterface {
    name = 'initialMigration1653587505546'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "project_posts" ADD CONSTRAINT "FK_d27ca00d79f2d85bd02550adcf5" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
